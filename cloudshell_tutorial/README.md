...
2. Open this tutorial on Github in a new tab by clicking [here](https://github.com/Tfmenard/terraform-vpn-lab/tree/master/cloudshell_tutorial) in order to complete the next step.
